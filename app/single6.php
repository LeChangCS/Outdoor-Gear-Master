...
$host="localhost";
    ...
    $sql="SELECT * FROM postItem ORDER BY ID desc limit 5,1";
    $res=mysqli_query($conn,$sql); 


   $queryOwner="SELECT itemowner FROM postItem ORDER BY ID desc limit 5,1";
...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="showImage.php?ID=<?php  $queryID="SELECT ID FROM postItem ORDER BY ID desc limit 5,1";
			        ...
			        <div class="thumb-image"> <img class="img-responsive" data-imagezoom="true" src="showImage.php?ID=<?php  $queryID="SELECT ID FROM postItem ORDER BY ID desc limit 5,1";
                            $resultID=mysqli_query($conn,$queryID);
			    ...
			    <li data-thumb="showImage.php?ID=<?php  $queryID="SELECT ID FROM postItem ORDER BY ID desc limit 5,1";
			         ...
			         <div class="thumb-image"> <img src="showImage.php?ID=<?php  $queryID="SELECT ID FROM postItem ORDER BY ID desc limit 5,1";
                            $resultID=mysqli_query($conn,$queryID);
...
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							<h1><?php
                                ...
                                ?></h1>
							<h1><?php
                                $IDquery="SELECT Description FROM postItem ORDER BY ID desc limit 5,1";
