...
function openwindow()
{
window.open("http://www.paypal.com", "", "height=600,width=850,scrollbars=yes,resizable=yes")
}
</script>
</head> 
...
<div class="header">
    ...
    <div class="container">
       ...
       <div class="row row content col-lg-offset-5" style="margin-top:50px">
       <h1> Amount:xxx USD</h1>
       </div>
      <div class="col-lg-offset-5"style="margin-top:20px">
         <h2>
          <a> <input type="submit" value="Pay Now"> </a>
         </h2>
      </div>
      <div>
          <a href="confirmation.php"><button value="">Paid successfully</button></a>  
      </div>
