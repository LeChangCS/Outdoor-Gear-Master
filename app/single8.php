...
$host="localhost";
    ...
    $sql="SELECT * FROM postItem ORDER BY ID desc limit 7,1";
    $res=mysqli_query($conn,$sql); 


   $queryOwner="SELECT itemowner FROM postItem ORDER BY ID desc limit 7,1";
...
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							<h1><?php
                                ...
                                ?></h1>
							<h1><?php
                                $IDquery="SELECT Description FROM postItem ORDER BY ID desc limit 7,1";
