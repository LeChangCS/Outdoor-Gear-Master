...
$host="localhost";
    ...
    $sql="SELECT * FROM postItem ORDER BY ID desc limit 3,1";
    $res=mysqli_query($conn,$sql); 


   $queryOwner="SELECT itemowner FROM postItem ORDER BY ID desc limit 3,1";
...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="showImage.php?ID=<?php  $queryID="SELECT ID FROM postItem ORDER BY ID desc limit 3,1";
			        ...
			        <div class="thumb-image"> <img class="img-responsive" data-imagezoom="true" src="showImage.php?ID=<?php  $queryID="SELECT ID FROM postItem ORDER BY ID desc limit 3,1";
                            $resultID=mysqli_query($conn,$queryID);
			    ...
			    <li data-thumb="showImage.php?ID=<?php  $queryID="SELECT ID FROM postItem ORDER BY ID desc limit 3,1";
			         ...
			         <div class="thumb-image"> <img src="showImage.php?ID=<?php  $queryID="SELECT ID FROM postItem ORDER BY ID desc limit 3,1";
                            $resultID=mysqli_query($conn,$queryID);
